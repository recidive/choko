...
Storage.prototype.processFields = function(schema, settings) {
  ...
  for (fieldName in settings.fields) {
    ...
    if (fieldSettings.type == 'reference' && fieldSettings.reference) {
      this.processReferenceField(schema, settings, fieldSettings);
    }
    else {
      this.processScalarField(schema, settings, fieldSettings);
    }
  }
};

Storage.prototype.processReferenceField = function(schema, settings, fieldSettings) {
...
Storage.prototype.processScalarField = function(schema, settings, fieldSettings) {
